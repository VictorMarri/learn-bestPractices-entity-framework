...
CREATE TABLE tb_imagem (
    ...
    "ProdutoModelId" integer NULL,
    "CriadoEm" criado_em NOT NULL,
    CONSTRAINT "PK_tb_imagem" PRIMARY KEY (id),
    CONSTRAINT "FK_tb_imagem_tb_produto_ProdutoModelId" FOREIGN KEY ("ProdutoModelId") REFERENCES tb_produto (id) ON DELETE RESTRICT
);
...
CREATE INDEX "IX_tb_imagem_ProdutoModelId" ON tb_imagem ("ProdutoModelId");
...
VALUES ('20211112191124_Init', '5.0.12');
